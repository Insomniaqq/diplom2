                ...
                <div class="p-6">
                    <form action="{{ route('suppliers.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="inn" id="inn" class="form-input" value="{{ old('inn') }}" required>
                            @error('inn')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact_person" id="contact_person" class="form-input" value="{{ old('contact_person') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" rows="3" class="form-textarea" required>{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="additional_info" id="additional_info" rows="3" class="form-textarea">{{ old('additional_info') }}</textarea>
