            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('budgets.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="year" id="year" class="form-input" value="{{ old('year', date('Y')) }}" required>
                        @error('year')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="month" id="month" class="form-input" value="{{ old('month') }}" min="1" max="12">
                        @error('month')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="comment" id="comment" class="form-input" value="{{ old('comment') }}">
                        @error('comment')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
